...
let url = baseurl + '/Database/Viewitems.php';
...
//Login page
    ...
    function checkLoggedIn() {
      ...
      if (usernameCookie !== "") {
        ...
        nav.appendChild( $("<p>").text(usernameCookie));
        // Ad esempio, reindirizza l'utente alla pagina principale
      } else {
        // L'utente non è loggato, visualizza il popup di login
        console.log("account o password errato");
      }
    }
    ...
    // Chiamare la funzione per controllare se l'utente è loggato
